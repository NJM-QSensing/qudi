...
class TimeTaggerMeasurementClass(Enum):
    UNCONFIGURED               =     0
    COUNT_BETWEEN_MARKERS      =     1
    COUNTER                    =     2
    TIME_DIFFERENCES           =     3

class TimeTaggerInputMode(Enum):
    DUMMY                      =    -1
    UNCONFIGURED               =     0
    SINGLE                     =     1
    SUM                        =     2
...
class TimeTaggerCounter(Base, SlowCounterInterface, FastCounterInterface):
    ...
    def on_activate(self):
        ...
        self._measurement_mode = TimeTaggerMeasurementClass.UNCONFIGURED
        ...
        if self._sum_channels:
            self._channel_mode = TimeTaggerInputMode.SUM
            ...
            self._channel_mode = TimeTaggerInputMode.SINGLE
            self._channel_apd = self._channel_apd_0

        self.log.info('TimeTagger 20 configured to use  channel {0}'
    ...
    # ==========================================================================
    #                 Slow Counter Interface Implementation BEGIN
    # ==========================================================================

    @SlowCounterInterface.get_constraints.register('SlowCounterInterface')
    def get_constraints_slowcounter(self):
    ...
    def get_counter_channels(self):
        if self._channel_mode == TimeTaggerInputMode.SINGLE:
    ...
    # ==========================================================================
    #                 Slow Counter Interface Implementation END
    # ==========================================================================


    # ==========================================================================
    #                 Fast Counter Interface Implementation BEGIN
    # ==========================================================================

    @FastCounterInterface.get_constraints.register('FastCounterInterface')
    def get_constraints_fastcounter(self):
    ...
    # ==========================================================================
    #                 Fast Counter Interface Implementation END
    # ==========================================================================

    def configure_Counter(self, channels, binwidth,n_values):
        self.counter = tt.Counter(
                self._tagger,
                channels=channels,
                binwidth=binwidth,
        ...
        self._measurement_mode = TimeTaggerMeasurementClass.COUNTER
        self.log.info('TimeTagger 20 measurement mode set to {0}'.format(TimeTaggerMeasurementClass.COUNTER))
        return 0

    def configure_CountBetweenMarkers(self, click_channel, begin_channel,end_channel,n_values):
        ...
        self._measurement_mode = TimeTaggerMeasurementClass.COUNT_BETWEEN_MARKERS
        self.log.info('TimeTagger 20 measurement mode set to {0}'
                      .format(TimeTaggerMeasurementClass.COUNT_BETWEEN_MARKERS))
        return 0

    def configure_TimeDifferences(self, click_channel, start_channel,next_channel,sync_channel,binwidth,n_bins,n_histograms):
        self.counter = tt.TimeDifferences(
            tagger=self._tagger,
            click_channel=click_channel,
        ...
        self._measurement_mode = TimeTaggerMeasurementClass.TIME_DIFFERENCES
        self.log.info('TimeTagger 20 measurement mode set to {0}'
                      .format(TimeTaggerMeasurementClass.TIME_DIFFERENCES))
        return 0