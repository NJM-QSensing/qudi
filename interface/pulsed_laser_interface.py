...
class PulsedLaserInterface(metaclass=InterfaceMetaclass):
    """ This interface can be used to control a pulsed laser. It handles power control, control modes and shutter states
    ...
    def get_status(self):
        """ Gets the current status of the laser, i.e. the mode (cw, digital modulation or analog modulation) and
            the output state (output on, output off)

        @return str, bool: mode ['cw', 'digital', 'analog'], output [True, False]
        """
        pass
