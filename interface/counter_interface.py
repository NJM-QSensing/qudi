...
class CounterMode(Enum):
    # starting methods
    # These measurement modes are based on Swabian Instruments Timetagger 20.
    # Implementation using different hardware will need to mimic the performance of 
    # these modes.
    UNCONFIGURED             = 0
    DUMMY                    = 1
    TIMEDIFFERENCES          = 2
    COUNTBETWEENMARKERS      = 3
    HISTOGRAM                = 4
    COUNTER                  = 5
    COUNTRATE                = 6
...
class CounterInterface(metaclass=InterfaceMetaclass):
    """ Interface class to define the controls for combined fast and slow counting devices.
    ...
    def get_constraints(self):
        """ Retrieve the hardware constraints from the counting device.
