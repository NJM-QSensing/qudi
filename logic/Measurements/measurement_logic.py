...
class MeasurementLogic(GenericLogic):
    """
    ...
    microwave2 = Connector(interface='MicrowaveInterface', default=None)
    microwave3 = Connector(interface='MicrowaveInterface', default=None)
    
    _number_of_mw = sum(source is not None for source in [microwave1, microwave2, microwave3])
    ...
    automatic = ConfigOption(name='automatic_data_collection', default=True)
    ...
    # counter settings
    __counter_record_length = StatusVar(default=3.0e-6)
    __counter_binwidth = StatusVar(default=1.0e-9)
    __counter_gates = StatusVar(default=0)
    ...
    # TODO: Implement in measurement class to give certain alternative data types
    # Example: ESR might be first derivative, Rabi would be FFT, etc.
