...
class CounterLogic(GenericLogic):
    """ This logic module prepares the pulse generator and counter for an NV experiment,
        then collects the data from the counter. This logic module will be considered the
        main control for scanning nitrogen-vacancy experiment.
